...
- Lists: bulleted and numbered (with nesting); wrapped continuation lines join the same item. Every numbered list is numbered independently and starts at the ordinal written in the markdown — a list opening with `4.` renders as `4.`
